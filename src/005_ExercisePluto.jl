...
# ╔═╡ 557a6f8a-0eca-4c6b-a4cc-54d44b0c2db2
using Distributions, Statistics, Plots

# ╔═╡ ab989d90-2d76-11ed-2eff-a99e77e638bd
md"# Exercise 1.9"

# ╔═╡ d6fc824d-86aa-4b35-a1bf-24b4c10fbe69
md"Let $X$ be a *Pareto* random variable (rv) with parameters $\beta>0$ and $\theta>0$ and therefore with probability density function (pdf) as follows:

$$f_X(x\,|\,\beta,\theta) \,=\,\frac{\beta \theta^{\beta}}{x^{\beta+1}}\mathbb{1}_{\{x\,\geq\,\theta\}}$$"

# ╔═╡ 46da8e86-177f-4bcc-b210-ffa84756ec2f
md"Consider a portfolio of 1-year term property and casualty insurance, under the collective risk model:

$$S \,=\, Y_1\,+\,\cdots\,+\,Y_N$$

where the *frequency* is a rv $N:=\max\{n\in\{0,1,\ldots\}: n\leq X-\theta\}$ and the conditional *severity* per claim is given by $Y\,|\,N=n\sim\text{Pareto}(2+\frac{1}{n}\,,\,\delta)$ for $n\geq 1.$ Calculate or estimate expected value, variance, median and $\text{VaR}_{0.995}$ of $S$ and $S\,|\,S>0,$ with parameter values $\beta=3, \theta=1=\delta.$"

# ╔═╡ 88cb62f8-cfdf-4548-b1b4-ff97461263d4
...
# ╔═╡ 6ac6da02-30f6-4585-81e3-3bc73d044add
md"### Calculations about $S$"

# ╔═╡ 4c772a09-5b22-4755-9490-e2c4ff952842
begin
...
# ╔═╡ 5d05617b-7bfc-47ff-965d-9118f12d315e
begin
